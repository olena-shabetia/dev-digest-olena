 ...
 * enforced via the PR (which carries workspace_id). `pr_intent` is owned by
 * the `intent` module (`modules/intent/repository.ts`, reached via
 * `container.intentRepo`) as of L03 — this class no longer touches it.
 *
