...
export class Container {
  ...
  /** Skills data-access, for cross-module reads (e.g. `conventions` upserting
   *  the generated `repo-conventions` skill). Even an `import type` of
   *  `SkillsRepository` from `modules/skills/repository.ts` trips
