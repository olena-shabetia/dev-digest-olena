...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Which ring/layer backend code belongs in (routes/service/repository/adapter/port), enforced by `pnpm arch` — first-party, **not** in `skills-lock.json`, do not add it there |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [react-testing-library](react-testing-library/SKILL.md) | Frontend | General-purpose React Testing Library guide with Vitest |
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | Where frontend code belongs and who may import it — folder placement, splitting, promotion, import direction — first-party, **not** in `skills-lock.json`, do not add it there |
